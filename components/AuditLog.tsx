...
const ENTITY_OPTIONS = ['TICKET', 'ACTIVITY', 'CUSTOMER', 'USER', 'TEAM', 'SALES_REQUEST', 'SYSTEM', 'RECURRING_SCHEDULE', 'BULK_REASSIGNMENT', 'SERVICE_FEEDBACK'];
